      ...
      >
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex items-center space-x-1 px-2 py-1 rounded-full text-xs bg-green-500 text-white">
          ...
          <AnimatePresence>
            {queueData.waitingPlayers.map((player, index) => (
              ...
              >
                ...
                <div className="text-yellow-400 text-sm">
                  <span className="font-bold text-yellow-400">{player.id === 1 ? 'Você' : 'Aguardando'}</span>
                </div>
              </motion.div>
            ))}
          </AnimatePresence>
