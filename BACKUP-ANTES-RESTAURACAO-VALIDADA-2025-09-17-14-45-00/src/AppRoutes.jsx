...
const RelatorioUsuarios = safeLazy(() => import("./pages/RelatorioUsuariosResponsive"), "Relatório de Usuários");
const RelatorioPorUsuario = safeLazy(() => import("./pages/RelatorioPorUsuario"), "Relatório por Usuário");
const RelatorioFinanceiro = safeLazy(() => import("./pages/RelatorioFinanceiroResponsive"), "Relatório Financeiro");
...
const UsuariosBloqueados = safeLazy(() => import("./pages/UsuariosBloqueadosResponsive"), "Usuários Bloqueados");
const Fila = safeLazy(() => import("./pages/FilaResponsive"), "Fila");
...
const Configuracoes = safeLazy(() => import("./pages/ConfiguracoesResponsive"), "Configurações");
const ExportarDados = safeLazy(() => import("./pages/ExportarDadosResponsive"), "Exportar Dados");
const TestePadronizacao = safeLazy(() => import("./pages/TestePadronizacao"), "Teste de Padronização");
const EstatisticasPadronizada = safeLazy(() => import("./pages/EstatisticasPadronizada"), "Estatísticas Padronizadas");
const TransacoesPadronizada = safeLazy(() => import("./pages/TransacoesPadronizada"), "Transações Padronizadas");
const LogsSistema = safeLazy(() => import("./pages/LogsSistemaResponsive"), "Logs do Sistema");
const ChutesRecentes = safeLazy(() => import("./pages/ChutesRecentesResponsive"), "Chutes Recentes");
const Game = safeLazy(() => import("./pages/GameResponsive"), "Jogo");
  ...
  return (
    <Routes>
      ...
      <Route path="/*" element={
        ...
        <Route path="teste-padronizacao" element={<TestePadronizacao />} />
        <Route path="estatisticas-padronizada" element={<EstatisticasPadronizada />} />
        <Route path="transacoes-padronizada" element={<TransacoesPadronizada />} />
