...
const FilaResponsive = () => {
  ...
  return (
    <ResponsiveWrapper
      featureName="RESPONSIVE_FILA"
      fallback={<Fila />}
      desktopFallback={<Fila />}
    >
      <FilaMobileTablet />
    </ResponsiveWrapper>
  );
...
const FilaMobileTablet = () => {
      ...
      <div className="bg-[#000717] text-white min-h-screen p-4">
        <div className="max-w-6xl mx-auto">
          <div className="mb-6">
            ...
            <p className="text-gray-400 text-sm">Status atual da fila de jogadores</p>
          </div>
            ...
            <div className="bg-[#111827] p-4 rounded-lg border border-[#2c3e50]">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-yellow-400">{dadosFila?.position || 0}</p>
                </div>
            ...
            <div className="bg-[#111827] p-4 rounded-lg border border-[#2c3e50]">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-blue-400">{dadosFila?.estimatedWait || 0} min</p>
                </div>
            ...
            <div className="bg-[#111827] p-4 rounded-lg border border-[#2c3e50]">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-green-400">{dadosFila?.totalInQueue || 0}</p>
                </div>
          ...
          <div className="bg-[#111827] rounded-lg border border-[#2c3e50] p-4">
            <h2 className="text-lg font-bold text-yellow-400 mb-4">Status Detalhado</h2>
            
            <div className="space-y-3">
              <div className="flex justify-between items-center py-2 border-b border-[#2c3e50]">
                <span className="text-gray-400 text-sm">Status da Partida:</span>
                <span className="text-white font-semibold text-sm">{dadosFila?.status || 'Aguardando'}</span>
              </div>
              
              <div className="flex justify-between items-center py-2 border-b border-[#2c3e50]">
                <span className="text-gray-400 text-sm">Já Chutou:</span>
                <span className={`font-semibold text-sm ${dadosFila?.jaChutou ? 'text-green-400' : 'text-red-400'}`}>
                  {dadosFila?.jaChutou ? 'Sim' : 'Não'}
                </span>
              </div>
              
              <div className="flex justify-between items-center py-2 border-b border-[#2c3e50]">
                <span className="text-gray-400 text-sm">Marcou Gol:</span>
                <span className={`font-semibold text-sm ${dadosFila?.marcouGol ? 'text-green-400' : 'text-red-400'}`}>
                  {dadosFila?.marcouGol ? 'Sim' : 'Não'}
                </span>
              </div>

              <div className="flex justify-between items-center py-2 border-b border-[#2c3e50]">
                <span className="text-gray-400 text-sm">Total de Jogadores:</span>
                <span className="text-white font-semibold text-sm">{dadosFila?.totalNaFila || 0}</span>
              </div>
              
              <div className="flex justify-between items-center py-2 border-b border-[#2c3e50]">
                <span className="text-gray-400 text-sm">Próximo Jogo:</span>
              ...
              <div className="flex justify-between items-center py-2">
                ...
                <span className="text-white font-semibold text-sm">{new Date().toLocaleTimeString('pt-BR')}</span>
              </div>
            </div>
          </div>
  ...
  return (
    <div className="bg-[#000717] text-white min-h-screen p-6">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-yellow-400 mb-2">Fila de Chute</h1>
